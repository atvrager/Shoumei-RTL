...
Defines the microcode instruction set for Zicsr + Zifencei execution.
Each ROM entry is 24 bits: [23:20] opcode, [19:18] dst, [17:16] src, [15:0] reserved.
-/
...
/-- Encode ROMEntry to 24-bit natural: [23:20] opcode, [19:18] dst, [17:16] src, [15:0] reserved -/
def ROMEntry.encode (e : ROMEntry) : Nat :=
  (e.opcode.toNat <<< 20) ||| (e.dst.val <<< 18) ||| (e.src.val <<< 16)
