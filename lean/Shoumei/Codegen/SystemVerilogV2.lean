/-
Codegen/SystemVerilogV2.lean - SystemVerilog V2 Code Generator (Hierarchical Mode)
...
namespace Shoumei.Codegen.SystemVerilogV2

open Shoumei.Codegen

/-! ## Context and State -/

/-- Code generation context for SystemVerilogV2.
...
/-- Generate SystemVerilog V2 code for a circuit -/
def toSystemVerilogV2 (c : Circuit) : String :=
  generateModule c

end Shoumei.Codegen.SystemVerilogV2
