...
def opTypeToMnemonic : Shoumei.RISCV.OpType → String
  ...
  | .FLW => "flw" | .FSW => "fsw"
  -- D extension
  | .FADD_D => "fadd.d" | .FSUB_D => "fsub.d" | .FMUL_D => "fmul.d"
  | .FDIV_D => "fdiv.d" | .FSQRT_D => "fsqrt.d"
  | .FMADD_D => "fmadd.d" | .FMSUB_D => "fmsub.d"
  | .FNMADD_D => "fnmadd.d" | .FNMSUB_D => "fnmsub.d"
  | .FEQ_D => "feq.d" | .FLT_D => "flt.d" | .FLE_D => "fle.d"
