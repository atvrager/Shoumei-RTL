...
`moduleName :=` references between circuits, certificates from
`verification/compositional-certs.txt`, docs from each file's leading
comment block.

- Lean files: **185**
- Circuits with a literal `name :=` (graph nodes): **49**
- Compositional certificates (Lean registry): **75**
- Proof files: **40**
...
- **30** circuits that instantiate nothing (leaves)
- **26** circuits nothing else instantiates (tops)
